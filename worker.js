...
const CANONICAL_LOCS = [
  { id:'kings_landing',    keywords:['king','landing','red keep','flea bottom','sept of baelor','dragonpit','iron throne','goldcloak','blackwater'] },
  { id:'dragonstone',      keywords:['dragonstone'] },
  { id:'winterfell',       keywords:['winterfell'] },
  { id:'white_harbor',     keywords:['white harbor','white harbour','manderly'] },
  { id:'the_wall',         keywords:['castle black','the wall','night's watch','shadow tower','eastwatch'] },
  { id:'dreadfort',        keywords:['dreadfort','bolton'] },
  { id:'barrowton',        keywords:['barrowton','barrow hall','dustin'] },
  { id:'flints_finger',    keywords:['flint's finger','cape kraken'] },
  { id:'last_hearth',      keywords:['last hearth','umber'] },
  { id:'deepwood_motte',   keywords:['deepwood','wolfswood','glover'] },
  { id:'karhold',          keywords:['karhold','karstark'] },
  { id:'torrhen_square',   keywords:['torrhen','tallhart'] },
  { id:'riverrun',         keywords:['riverrun','tully'] },
  { id:'harrenhal',        keywords:['harrenhal'] },
  { id:'the_twins',        keywords:['the twins','frey','green fork crossing'] },
  { id:'seagard',          keywords:['seagard','mallister'] },
  { id:'acorn_hall',       keywords:['acorn hall','smallwood'] },
  { id:'the_eyrie',        keywords:['eyrie','the vale','arryn'] },
  { id:'gulltown',         keywords:['gulltown','grafton'] },
  { id:'the_gates_of_the_moon', keywords:['gates of the moon','giant's lance'] },
  { id:'runestone',        keywords:['runestone','royce'] },
  { id:'heart_home',       keywords:['heart's home','corbray'] },
  { id:'casterly_rock',    keywords:['casterly rock','lannister'] },
  { id:'lannisport',       keywords:['lannisport'] },
  { id:'golden_tooth',     keywords:['golden tooth','lefford'] },
  { id:'crakehall',        keywords:['crakehall'] },
  { id:'ashemark',         keywords:['ashemark','marbrand'] },
  { id:'highgarden',       keywords:['highgarden','tyrell'] },
  { id:'oldtown',          keywords:['oldtown','hightower','citadel','honeywine'] },
  { id:'ashford',          keywords:['ashford'] },
  { id:'horn_hill',        keywords:['horn hill','tarly'] },
  { id:'cider_hall',       keywords:['cider hall','fossoway'] },
  { id:'three_towers',     keywords:['three towers','costayne'] },
  { id:'brightwater_keep', keywords:['brightwater','florent'] },
  { id:'storms_end',       keywords:['storm's end','storms end','shipbreaker'] },
  { id:'summerhall',       keywords:['summerhall'] },
  { id:'bronzegate',       keywords:['bronzegate','buckler'] },
  { id:'stonehelm',        keywords:['stonehelm','swann'] },
  { id:'crow_s_nest',      keywords:['crow's nest','morrigen'] },
  { id:'sunspear',         keywords:['sunspear','martell','spear tower','shadow city'] },
  { id:'ghost_hill',       keywords:['ghost hill','toland'] },
  { id:'godsgrace',        keywords:['godsgrace','allyrion','greenblood'] },
  { id:'yronwood',         keywords:['yronwood'] },
  { id:'the_water_gardens',keywords:['water gardens'] },
  { id:'pyke',             keywords:['pyke','greyjoy'] },
  { id:'great_wyk',        keywords:['great wyk','goodbrother'] },
  { id:'old_wyk',          keywords:['old wyk','nagga'] },
  { id:'lordsport',        keywords:['lordsport'] },
  { id:'duskendale',       keywords:['duskendale','darklyn'] },
  { id:'rosby',            keywords:['rosby'] },
  { id:'stokeworth',       keywords:['stokeworth'] },
  { id:'braavos',          keywords:['braavos','iron bank','faceless','titan'] },
  { id:'pentos',           keywords:['pentos'] },
  { id:'volantis',         keywords:['volantis','long bridge'] },
  { id:'myr',              keywords:['myr','myrish'] },
  { id:'lys',              keywords:['lys','lyseni'] },
  { id:'tyrosh',           keywords:['tyrosh'] },
  { id:'norvos',           keywords:['norvos'] },
  { id:'qohor',            keywords:['qohor','black goat'] },
